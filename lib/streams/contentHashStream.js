...
const fields = [
  { key: 'TASE1_NIMETUS_LIIGIGA', norm: normalize.string },
  { key: 'TASE2_NIMETUS_LIIGIGA', norm: normalize.string },
  { key: 'TASE5_NIMETUS_LIIGIGA', norm: normalize.string },
  { key: 'TASE6_NIMETUS_LIIGIGA', norm: normalize.string },
  { key: 'TASE7_NIMETUS_LIIGIGA', norm: normalize.string }
];
